 ...
 *     HTTP/1.1 200 OK
 *     Content-Type: application/json
 *     Link: <https://comem-travel-log-api.herokuapp.com/api/users?pageSize=2&page=2>; rel="self last", <https://comem-travel-log-api.herokuapp.com/api/users?pageSize=2&page=1>; rel="first prev"
 *     Pagination-Page: 2
 *     Pagination-PageSize: 2
 *     Pagination-Total: 3
 *     Pagination-Filtered-Total 3
 *
 *     [
 *       {
 *         "createdAt": "2018-12-09T11:58:18.265Z",
